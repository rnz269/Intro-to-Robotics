...
void break_out_of_loop()
{
	setMotorSync(motorB, motorC, 0, 80);
	sleep(1000);
}
...
{
	while(true)
		// If the current state is charging or scanning or defense and found edge change to state detected edge
		if(current_State < 3)
